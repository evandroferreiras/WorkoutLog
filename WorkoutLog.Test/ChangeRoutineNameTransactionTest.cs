...
namespace WorkoutLog.Test
{
    ...
    public class ChangeRoutineNameTransactionTest : BaseTest
    {
        ...
        public void NameShouldBeChanged()
        {
            ...
            var wid = new Workout.WorkoutIdentity(12, 13, 14, 1042);
            var r = new RoutineBuilder(wid.WorkoutId, wid.RoutineId, "Default")
                          .AddNormalRoutineExercise(wid.DayId, wid.RoutineExerciseId, exerciseId, 10, 25)
                          .Build();

            var awt = new AddWorkoutTransaction(wid, new[] { r });
            awt.Execute();
        ...
        {
            var wid = new Workout.WorkoutIdentity(1266, 1366, 1466, 10426);
